...
class COORD:
    ...
    def toInt(self, XSize):
        return self.X + self.Y*XSize
...
def HeadingDirection(coord1, coord2):
    diffCord = coord2 - coord1
    if diffCord.X == 0 and diffCord.Y == 0:
        return -1
